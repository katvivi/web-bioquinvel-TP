function retrieve(id){
    ...
    $.ajax({        
        ...
        success : function(response){
            ...
            $("#lblNombre").html(administrador.nombre);
...
function show(list){ 
    ...
    list.forEach(administrador => {
        ...
        $("#tblAdministradores").append('<tr>'          
            ...
            //Boton de consultar
            + '<td>'
            + '<button onclick="retrieve('+ administrador.idAdministrativo +')" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#mdAdministrador"">Detalle</button>'
            + '</td>'                        
        +'</tr>');
    });
}
